  ...
  return (
    <div className="flex flex-col gap-4 w-screen px-4 pt-16">
      <div className="w-full flex flex-col gap-2 h-72 items-center justify-center">
        <h1 className="text-4xl font-bold pb-2">Welcome to genspoai.</h1>
        <p className="text-xl text-gray-500 text-center">See what our community is creating and start generating your own inspiration</p>
        <Link href="/create">
          <Button className="mt-4 font-bold">Start creating</Button>
        </Link>
      </div>
      {isLoading ? (
